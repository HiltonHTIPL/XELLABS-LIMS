...
function ARModal({ samples, services, onClose, onDone, preselectedSampleId, editing }: { samples: LabSample[]; services: SenaiteAnalysisService[]; onClose: () => void; onDone: () => void; preselectedSampleId?: string; editing?: AnalysisRequest | null }) {
