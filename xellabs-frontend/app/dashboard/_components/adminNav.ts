...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { label: 'Manufacturers', href: '/dashboard/manufacturers', icon: 'precision_manufacturing', roles: ['admin', 'lab_manager'],
  ...
  { label: 'Workflow Configurator', href: '/dashboard/workflow-configurator', icon: 'device_hub', roles: ['admin', 'lab_manager'],
