...
export const ADMIN_SECTIONS: AdminSection[] = [
  { label: 'Users',        href: '/dashboard/admin/users',   icon: 'group',       roles: ['admin'],
    description: 'Manage lab staff accounts and role assignments.' },
  { label: 'Sample Types', href: '/dashboard/sample-types', icon: 'category',   roles: ['admin', 'manager', 'lab_manager'],
    description: 'Define sample matrix categories (e.g. Water, Soil) used across sampling and specifications.' },
  { label: 'Sample Templates', href: '/dashboard/sample-templates', icon: 'view_list', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Container Types', href: '/dashboard/container-types', icon: 'inventory_2', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Catalog of container types (bottle, vial, jar) offered when defining Sample Containers.' },
  { label: 'Sample Containers', href: '/dashboard/sample-containers', icon: 'science', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Preservations', href: '/dashboard/preservations', icon: 'ac_unit', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Preservation methods (e.g. cold, acidified) applied to sample containers.' },
  { label: 'Sample Points', href: '/dashboard/sample-points', icon: 'place', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Named collection locations available when scheduling or logging samples.' },
  { label: 'Sampling Deviations', href: '/dashboard/sampling-deviations', icon: 'warning_amber', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Analyses',     href: '/dashboard/analyses',     icon: 'biotech',    roles: ['admin', 'manager', 'lab_manager'],
    description: 'Manage analysis services — the tests offered, pricing, and lab catalog.' },
  { label: 'Calculations', href: '/dashboard/calculations', icon: 'functions', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Define result formulas and interim fields used by Analyses.',
    dependsOn: ['Analyses'] },
  { label: 'Specifications', href: '/dashboard/specifications', icon: 'rule',    roles: ['admin', 'manager', 'lab_manager'],
    description: 'Set acceptable result ranges per Sample Type and Analysis.',
    dependsOn: ['Sample Types', 'Analyses'] },
  { label: 'Dynamic Analysis Specifications', href: '/dashboard/dynamic-analysis-specifications', icon: 'dynamic_feed', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Rule-based specification limits that adjust per sample context.' },
  { label: 'Analysis Requests', href: '/dashboard/analysis-requests', icon: 'assignment_turned_in', roles: ['admin', 'manager', 'lab_manager', 'analyst', 'verifier'],
    description: 'View and manage submitted analysis requests.' },
  { label: 'Results',      href: '/dashboard/results',      icon: 'science',     roles: ['admin', 'manager', 'lab_manager', 'analyst', 'verifier'],
    description: 'Enter, verify, and review analysis results.' },
  { label: 'Worksheet Templates', href: '/dashboard/worksheet-templates', icon: 'grid_on', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Suppliers', href: '/dashboard/suppliers', icon: 'local_shipping', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Vendors that supply QC reference materials; containers for Reference Samples.', countPortalType: 'Supplier' },
  { label: 'Reference Definitions', href: '/dashboard/reference-definitions', icon: 'straighten', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Reference Samples', href: '/dashboard/reference-samples', icon: 'colorize', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Master Data Import', href: '/dashboard/master-data-import', icon: 'upload_file', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Instrument Register', href: '/dashboard/instruments', icon: 'build_circle', roles: ['admin'],
    description: 'Register lab instruments; the Instruments tab feeds Analysis Services and Worksheets directly.',
    dependsOn: ['Instrument Types', 'Manufacturers', 'Suppliers', 'Methods'] },
  { label: 'Instrument List', href: '/dashboard/instrument-list', icon: 'precision_manufacturing', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Browse instruments, calibration and maintenance status.',
    dependsOn: ['Instrument Register'] },
  { label: 'Storage List', href: '/dashboard/storage-list', icon: 'inventory_2', roles: ['admin', 'manager', 'lab_manager'],
  ...
  { label: 'Data Analytics', href: '/dashboard/analytics', icon: 'insights', roles: ['admin', 'manager', 'lab_manager', 'analyst'],
  ...
  { label: 'Analysis Categories', href: '/dashboard/analysis-categories', icon: 'account_tree', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Grouping categories used to organize Analyses.', countPortalType: 'AnalysisCategory' },
  { label: 'Attachment Types', href: '/dashboard/attachment-types', icon: 'attach_file', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Classify file attachments uploaded to samples and requests.', countPortalType: 'AttachmentType' },
  { label: 'Batch Labels', href: '/dashboard/batch-labels', icon: 'label', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Tags applied to Batches for grouping and filtering.', countPortalType: 'BatchLabel' },
  { label: 'Instrument Locations', href: '/dashboard/instrument-locations', icon: 'place', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Physical locations where instruments are installed.', countPortalType: 'InstrumentLocation' },
  { label: 'Instrument Types', href: '/dashboard/instrument-types', icon: 'category', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Categories of instruments used across the lab.', countPortalType: 'InstrumentType' },
  { label: 'Manufacturers', href: '/dashboard/manufacturers', icon: 'precision_manufacturing', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Instrument manufacturers, required when registering an instrument.', countPortalType: 'Manufacturer' },
  { label: 'Interpretation Templates', href: '/dashboard/interpretation-templates', icon: 'description', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Reusable result-interpretation text blocks for reports.', countPortalType: 'InterpretationTemplate' },
  { label: 'Lab Contacts', href: '/dashboard/lab-contacts', icon: 'contact_page', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Internal lab staff contacts linked to reports and departments.', countPortalType: 'LabContact' },
  { label: 'Lab Departments', href: '/dashboard/lab-departments', icon: 'corporate_fare', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Organizational departments within the lab.', countPortalType: 'Department' },
  { label: 'Lab Products', href: '/dashboard/lab-products', icon: 'shopping_bag', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Billable products/services offered by the lab.', countPortalType: 'LabProduct' },
  { label: 'Labels', href: '/dashboard/labels', icon: 'sell', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Printable label templates for samples and containers.', countPortalType: 'Label' },
  { label: 'Laboratory Information', href: '/dashboard/laboratory', icon: 'apartment', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Lab identity, accreditation, and contact details.' },
  { label: 'Workflow Configurator', href: '/dashboard/workflow-configurator', icon: 'device_hub', roles: ['admin', 'manager', 'lab_manager'],
    description: 'Design the sample lifecycle workflow and e-signature mapping.' },
]
