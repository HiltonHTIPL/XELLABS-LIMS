  ...
  return (
    <div style={{ padding: 20, backgroundColor: '#F7F8FC', minHeight: '100%' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
        ...
        <div style={{ width: 150, height: 32, borderRadius: 8, background: '#E5E7EB' }} className="animate-pulse" />
      </div>
      ...
      <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #E8EAF2' }}>
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} style={{ padding: '14px 16px', borderBottom: '1px solid #F9FAFB', display: 'flex', gap: 12, alignItems: 'center' }}>
            <div style={{ width: 90, height: 13, borderRadius: 4, background: '#E5E7EB' }} className="animate-pulse" />
            <div style={{ flex: 1, height: 13, borderRadius: 4, background: '#E5E7EB' }} className="animate-pulse" />
            <div style={{ width: 70, height: 13, borderRadius: 4, background: '#E5E7EB' }} className="animate-pulse" />
          </div>
        ))}
      </div>
    </div>
