...
export default function GroupModal({ onClose, onDone }: { onClose: () => void; onDone: (msg: string) => void }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 300, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.30)' }}>
      <div style={{ width: 380, backgroundColor: '#fff', borderRadius: 12, boxShadow: '0 12px 32px rgba(0,0,0,0.16)' }}>
