...
export default function SampleOverviewDetail({
  ...
  sampleContainers, batches, analysisSpecifications, preservations, samplingDeviations, samplePoints, isDrawer,
}: Props) {
  ...
  useEffect(() => {
    ...
    // Skip inside the list drawer, which never carries ?edit=1 of its own.
    if (!isDrawer && searchParams.get('edit') === '1' && id) {
