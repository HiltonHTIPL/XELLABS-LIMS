...
function SpecificationModal({ editing, services, sampleTypes, dynamicSpecs, onClose, onDone }: {
  ...
  return (
    <div onClick={e => { if (e.currentTarget === e.target) onClose() }}
      ...
      <div className="xl-visible-scrollbar" style={{ position: 'fixed', top: 'var(--dashboard-header-h)', right: 0, bottom: 'var(--dashboard-footer-h)', width: 760, backgroundColor: '#fff', boxShadow: '-6px 0 32px rgba(0,0,0,0.15)', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
