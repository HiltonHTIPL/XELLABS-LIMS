...
function ModalShell({ title, subtitle, icon, onClose, children }: {
  ...
  return (
    <div onClick={e => { if (e.currentTarget === e.target) onClose() }}
      ...
      <div style={{ backgroundColor: '#fff', borderRadius: 16, width: 460, boxShadow: '0 20px 60px rgba(0,0,0,0.2)', maxHeight: '90vh', overflowY: 'auto' }}>
...
export default function InstrumentMaintenanceShell({
  ...
  // Resets the filter input when switching tabs.
